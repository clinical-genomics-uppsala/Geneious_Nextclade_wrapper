...
output_path="C:\\Users\\KMB\\TomasC\\"
...
nextclade_path="C:/Users/KMB/nextclade"
...
r = open("{}{}_final.tsv".format(output, batch_name), 'w', newline='')
writer = csv.writer(r)
...
with open('{}{}.tsv'.format(output,batch_name), 'r') as csvfile:
     ...
     for row in spamreader:
         if "seqName" in row[0]:
             ...
             row.append(str(output_results2.replace("\n", "")))
             row.append(str(data['tag']))
             writer.writerow(row)
...
copy_files=["Xcopy", "output\\", "{}\\".format(output_permanent)]
